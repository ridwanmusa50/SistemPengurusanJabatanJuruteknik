...
public class loginPentadbir extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setDisplayHomeAsUpEnabled(true); // atur butang patah balik ke antara muka sebelum di navigation bar atas
            ...
            lupaKataLaluan.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    finish();
                    startActivity(new Intent(loginPentadbir.this, setSemulaKataLaluan.class));
                }
            });
    }
    ...
    private void sahkanPengguna(String emelPengguna, String kataLaluan, String idPengguna)
    {
        mAuth.signInWithEmailAndPassword(emelPengguna, kataLaluan).addOnCompleteListener(new OnCompleteListener<AuthResult>()
        {
            ...
            public void onComplete(@NonNull Task<AuthResult> task)
            {
                                ...
                                public void onSuccess(DocumentSnapshot documentSnapshot) {
                                    if (documentSnapshot.exists()) {
                                        ...
                                        if (jawatan.equals("JURUTEKNIK")) {
                                            ...
                                            Toast.makeText(loginPentadbir.this, "Gagal untuk log masuk! Akaun terdaftar sebagai akaun JURUTEKNIK", Toast.LENGTH_LONG).show();
                                        } else {
                                            progressBar.setVisibility(View.GONE);
                                            ...
                                            if (emelPengguna.equals(documentSnapshot.getString("emelPengguna"))) {
                                                ...
                                                finish();
                                                startActivity(new Intent(loginPentadbir.this, utamaPentadbir.class)); //terus ke laman utama pentadbir
                                            } else {
                                                Toast.makeText(loginPentadbir.this, "Gagal untuk log masuk! ID Pengguna tidak sepadan dengan Emel", Toast.LENGTH_LONG).show();
                                            }
                                        }
                                    }
                                    else
                                    {
                                        progressBar.setVisibility(View.GONE);
                                        Toast.makeText(loginPentadbir.this, "Gagal untuk log masuk! ID Pengguna tiada dalam pangkalan data", Toast.LENGTH_LONG).show();
                                        idPengguna1.requestFocus();
                                    }
                                }
                            });
                ...
                {
                    progressBar.setVisibility(View.GONE);
                    Toast.makeText(loginPentadbir.this, "Gagal untuk log masuk! Sila semak kesahihan akaun", Toast.LENGTH_LONG).show();
                }
            }
        });
    }
